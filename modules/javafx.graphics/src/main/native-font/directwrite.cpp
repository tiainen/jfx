...
jboolean font_checkAndClearException(JNIEnv* env)
{
...
void cacheDWRITE_GLYPH_METRICSFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !tmpClass) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.leftSideBearing) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.advanceWidth) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.rightSideBearing) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.topSideBearing) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.advanceHeight) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.bottomSideBearing) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.verticalOriginY) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_METRICSFc.init) {
...
void cacheDWRITE_MATRIXFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.m11) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.m12) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.m21) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.m22) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.dx) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.dy) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_MATRIXFc.init) {
...
void cacheDWRITE_GLYPH_RUNFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.fontFace) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.fontEmSize) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.glyphIndices) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.glyphAdvances) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.advanceOffset) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.ascenderOffset) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.isSideways) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.bidiLevel) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_GLYPH_RUNFc.init) {
...
void cacheDWRITE_SCRIPT_ANALYSISFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !DWRITE_SCRIPT_ANALYSISFc.script) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_SCRIPT_ANALYSISFc.shapes) {
    ...
    if (font_checkAndClearException(env) || !DWRITE_SCRIPT_ANALYSISFc.init) {
...
void cacheD2D1_PIXEL_FORMATFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !D2D1_PIXEL_FORMATFc.format) {
    ...
    if (font_checkAndClearException(env) || !D2D1_PIXEL_FORMATFc.alphaMode) {
    ...
    if (font_checkAndClearException(env) || !D2D1_PIXEL_FORMATFc.init) {
...
void cacheD2D1_RENDER_TARGET_PROPERTIESFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.type) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.pixelFormat) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.dpiX) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.dpiY) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.usage) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.minLevel) {
    ...
    if (font_checkAndClearException(env) || !D2D1_RENDER_TARGET_PROPERTIESFc.init) {
...
void cacheD2D1_COLOR_FFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !D2D1_COLOR_FFc.r) {
    ...
    if (font_checkAndClearException(env) || !D2D1_COLOR_FFc.g) {
    ...
    if (font_checkAndClearException(env) || !D2D1_COLOR_FFc.b) {
    ...
    if (font_checkAndClearException(env) || !D2D1_COLOR_FFc.a) {
    ...
    if (font_checkAndClearException(env) || !D2D1_COLOR_FFc.init) {
...
void cacheD2D1_POINT_2FFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !D2D1_POINT_2FFc.x) {
    ...
    if (font_checkAndClearException(env) || !D2D1_POINT_2FFc.y) {
    ...
    if (font_checkAndClearException(env) || !D2D1_POINT_2FFc.init) {
...
void cacheD2D1_MATRIX_3X2_FFields(JNIEnv *env)
{
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._11) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._12) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._21) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._22) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._31) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc._32) {
    ...
    if (font_checkAndClearException(env) || !D2D1_MATRIX_3X2_FFc.init) {
